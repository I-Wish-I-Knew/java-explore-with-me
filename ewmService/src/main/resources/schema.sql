...
(
    ...
    CONSTRAINT fk_invitations_events FOREIGN KEY (event_id) REFERENCES events (event_id) ON DELETE CASCADE,
    CONSTRAINT fk_invitations_sender_id_users FOREIGN KEY (sender_id) REFERENCES users (user_id) ON DELETE CASCADE,
    CONSTRAINT fk_invitations_recipient_id_users FOREIGN KEY (recipient_id) REFERENCES users (user_id) ON DELETE CASCADE
);
